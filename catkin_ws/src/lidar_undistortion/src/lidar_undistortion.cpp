...
public:
    ...
    LidarMotionCalibrator()
    {
      ...
      nh_param.param<string>("imu_topic", imu_topic_, "/imu_data");
      nh_param.param<double>("imu_frequency", imu_frequency_, 10.0);
    ...
    void LidarCallback(const sensor_msgs::LaserScanConstPtr& _lidar_msg)
    {
      ...
      cout << "imu_buffer_size is " << imuCircularBuffer_.size() << endl;
