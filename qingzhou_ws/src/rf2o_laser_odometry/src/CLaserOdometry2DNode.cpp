...
//定义Odom协方差矩阵
boost::array<double,36> ODOM_POSE_COVARIANCE = {1e-3, 0, 0, 0, 0, 0, 0, 1e-3, 0, 0, 0, 0,0, 0, 1e6, 0, 0, 0,0, 0, 0, 1e6, 0, 0,0, 0, 0, 0, 1e6, 0,0, 0, 0, 0, 0, 1e-3};
boost::array<double,36> ODOM_TWIST_COVARIANCE = {1e-3, 0, 0, 0, 0, 0, 0, 1e6, 0, 0, 0, 0,0, 0, 1e6, 0, 0, 0,0, 0, 0, 1e6, 0, 0,0, 0, 0, 0, 1e6, 0,0, 0, 0, 0, 0, 1e-3};
  ...
  CLaserOdometry2D()
{
  ...
  laser_sub = n.subscribe<sensor_msgs::LaserScan>(laser_scan_topic,50,&CLaserOdometry2DNode::LaserCallBack,this);
...
bool CLaserOdometry2DNode::setLaserPoseFromTf()
{
  ...
  try
  {
    tf_listener.waitForTransform("/base_link","laser",ros::Time(),ros::Duration(5.0));
