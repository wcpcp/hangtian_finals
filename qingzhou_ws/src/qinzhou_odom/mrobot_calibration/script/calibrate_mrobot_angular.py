...
class CalibrateAngular():
    def __init__(self):
        ...
        self.test_angle = rospy.get_param("~test_angle", 360.0)
        self.test_angle = radians(self.test_angle ) # degrees converted to radians

        self.speed = rospy.get_param("~angle_speed",0.5)  # radians per second
        self.tolerance = rospy.get_param("~tolerance_angle",1)  #degrees
        self.tolerance = radians(self.tolerance)  # degrees converted to radians
        self.odom_angular_scale_correction = rospy.get_param("~odom_angle_scale",1.0)
