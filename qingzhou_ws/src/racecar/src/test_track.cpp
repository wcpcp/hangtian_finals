...
int main(int argc, char **argv) {
    ...
    loadWaypoints(param_waypoints_filename, param_scale, &gWaypoints);                                  //将轨迹点文件中的点记录到gWaypoints数组中
    interpolatePathCubic(gWaypoints, param_density, &gPath);                                                             //得到gPath路径    具体的不是很懂，再看看
    int pub_goal_mode;
